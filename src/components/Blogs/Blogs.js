...
const Blogs = () => {
  return (
    ...
    <div className='blog-card-container flex-vt'>
                <img className="blog-img" src="https://res.cloudinary.com/shrushti23/image/upload/v1659021463/event-bubbling_xhr4iu.jpg"/>
    ...
    <div className='blog-card-container flex-hz'>
                <img className="blog-img" src="https://res.cloudinary.com/shrushti23/image/upload/v1659021501/3jn7wmvw86tae27a9ika_mtrdiv.jpg"/>
                <div className='blog-title'>Prototypes in JavaScript!</div>
                <div className='project-card-desc'>In this article we will understand what are prototypes ,what are global objects , what is this proto property and how inheritance works in JavaScript underneath the hood.
                <a href="https://dev.to/shrushti23/prototypes-in-javascript-101a"><p>Read more...</p></a>
                
                </div>
            </div>
            <div className='blog-card-container flex-vt'>
                <img className="blog-img" src="https://res.cloudinary.com/shrushti23/image/upload/v1659021420/this-keyowrd_q3hjtn.jpg"/>
                <div className='blog-title'>More About ‘this’ Keyword in JavaScript</div>
